...
const Footer = () => {
  ...
  const {about, quickLinks, contactUS, followUs} = useSelector(state => state.lang.value.footer)
  return (
    <>
      ...
      <div className="col-sm-6 col-md-6 col-lg-3 col-xl-3">
        <div className="footer_contact_widget">
          ...
          <ul className="list-unstyled">
            ...
            <li>
              <a href="#">{contactUS.li3[lang]}</a>
            </li>
            <li>
              <a href="tel:+4733378901">{contactUS.li4[lang]}</a>
            </li>
            <li>
              <a href="tel:+4733378901">{contactUS.li5[lang]}</a>
            </li>
          </ul>
        </div>
      </div>
