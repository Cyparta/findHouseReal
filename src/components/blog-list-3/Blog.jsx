  ...
  return (
    <>
      {blogs.slice(0, 6).map((item) => (
        <div className="col-lg-4 col-md-6" key={item.id[lang]}>
              ...
              <div className="fp_footer">
                <ul className="fp_meta float-start mb0">
                  <li className="list-inline-item">
                    <a href="#">
                      <img
                        src={item.posterAvatar[lang]}
                        alt={item.posterAvatar[lang]}
                      />
                    </a>
                  </li>
                  <li className="list-inline-item">
                ...
                <a className="fp_pdate float-end text-thm" href="#">
                  {translatedata.readmore[lang]}{" "}
                  <span className={lang === "ar" ? "flaticon-back" : "flaticon-next"}></span>
                </a>
              </div>
              {/* End fb_footer */}
            </div>
