...
const index = () => {
  ...
  const main = useSelector((state) => state.lang.value.agentDetail.box);
                    ...
                    <div className="feat_property list style2 agent">
                      ...
                      <div className="details">
                        <div className="tc_content">
                          ...
                          <p className="text-thm">{main.text[lang]}</p>
                          <ul className="prop_details mb0">
                            <li>
                              <a href="#">{main.office[lang]}</a>
                            </li>
                            <li>
                              <a href="#">{main.mobile[lang]}</a>
                            </li>
                            <li>
                              <a href="#">{main.fax[lang]}</a>
                            </li>
                            <li>
                              <a href="#">{main.email[lang]}</a>
                            </li>
                          </ul>
                        </div>
