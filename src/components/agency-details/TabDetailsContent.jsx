          ...
          <div className="product_single_content">
            <div className="mbp_pagination_comments">
              <div className="total_review">
                ...
                <a className={lang==='ar'?"left write_review float-end fn-xsd":"write_review float-end fn-xsd"} href="#">
                {main.writeReview[lang]}
                </a>
              </div>
              {/* End .total_review */}
              <Comments />
