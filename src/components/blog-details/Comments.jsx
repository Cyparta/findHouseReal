  ...
  const commmetContent = [
    {
      ...
      the cooler seasons!`,
        ar: `منزل جميل ، خلاب للغاية وقريب من كل شيء في جي تيري! دافئ قليلاً لقضاء عطلة نهاية أسبوع حارة ، لكنني أحب العودة خلال المواسم الباردة!`,
      },
    },
    {
      id: { en: "2", ar: "2" },
    ...
    <>
      {commmetContent.map((item) => (
        <div className="mbp_first media" key={item.id[lang]}>
          <img
            src={`/findHouse/assets/images/testimonial/${item.img[lang]}.png`}
            className="mr-3"
            alt={item.img[lang]}
          />
