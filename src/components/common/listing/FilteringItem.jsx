      ...
      <li>
        <div className="search_option_two">
          <div className="candidate_revew_select">
            ...
            >
              <option value="">{main.type.li[lang]}</option>
              <option value={main.type.li2[lang]}>{main.type.li2[lang]}</option>
              <option value={main.type.li3[lang]}>{main.type.li3[lang]}</option>
              <option value={main.type.li4[lang]}>{main.type.li4[lang]}</option>
              <option value={main.type.li5[lang]}>{main.type.li5[lang]}</option>
              <option value={main.type.li6[lang]}>{main.type.li6[lang]}</option>
              <option value={main.type.li7[lang]}>{main.type.li7[lang]}</option>
            </select>
          </div>
        </div>
      </li>
        ...
        <div className="search_option_two">
          <div className="candidate_revew_select">
            <select
              ...
              value={getGarages}
            >
              <option value="">{main.garages.opt[lang]}</option>
              <option value={main.garages.opt2[lang]}>
                {main.garages.opt2[lang]}
              </option>
              <option value={main.garages.opt3[lang]}>
                {main.garages.opt3[lang]}
              </option>
              <option value={main.garages.opt4[lang]}>
                {main.garages.opt4[lang]}
              </option>
            </select>
          </div>
        </div>
        ...
        <div className="search_option_two">
          <div className="candidate_revew_select">
            <select
              ...
              value={getBuiltYear}
            >
              <option value="">{main.built[lang]}</option>
          ...
          <div className="panel">
            <div className="panel-heading">
              <h4 className="panel-title">
                ...
                >
                  <i className="flaticon-more"></i> {main.advanced[lang]}
                </a>
              </h4>
            </div>
            {/* End .panel-heading */}
